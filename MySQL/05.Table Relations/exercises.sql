...
(
    ...
    `name` VARCHAR(30),
    `manufacturer_id` INT,
    CONSTRAINT `fk_models_manifacturer`
...
INSERT INTO `students_exams`(`student_id`, `modelsexam_id`)
VALUES(1, 101),
	(1, 102),
    (2, 101),
    (3, 103),
...
(
    ...
    `name` VARCHAR(30),
    `manager_id` INT,
    CONSTRAINT `fk_teachers_manager_id`
...
(
    ...
    `student_id` INT,
    CONSTRAINT `fk_payments_students`peaks
    FOREIGN KEY (`student_id`) REFERENCES `students`(`student_id`)
);
